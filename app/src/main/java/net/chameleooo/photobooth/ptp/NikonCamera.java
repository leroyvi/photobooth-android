...
import net.chameleooo.photobooth.ptp.commands.GetDevicePropDescCommand;
import net.chameleooo.photobooth.ptp.commands.InitiateCaptureCommand;
import net.chameleooo.photobooth.ptp.commands.RetrieveAddedObjectInfoAction;
import net.chameleooo.photobooth.ptp.commands.SimpleCommand;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonAfDriveCommand;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonCloseSessionAction;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonEventCheckCommand;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonGetLiveViewImageAction;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonGetLiveViewImageCommand;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonOpenSessionAction;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonStartLiveViewAction;
import net.chameleooo.photobooth.ptp.commands.nikon.NikonStopLiveViewAction;
